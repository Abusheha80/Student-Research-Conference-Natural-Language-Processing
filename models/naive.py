...
plt.tight_layout()
plt.savefig(f'{output_dir}/naive_bayes_confusion_matrix.png')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(f'{output_dir}/naive_bayes_roc_curve.png')
plt.close()
...
metrics_df.to_csv(f'{output_dir}/naive_bayes_metrics.csv', index=False)
